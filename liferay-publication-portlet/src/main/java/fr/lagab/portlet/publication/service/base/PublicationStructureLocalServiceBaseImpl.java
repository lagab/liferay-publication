...
import fr.lagab.portlet.publication.service.PublicationStructureLocalService;
import fr.lagab.portlet.publication.service.persistence.PublicationPersistence;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the publication structure local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fr.lagab.portlet.publication.service.impl.PublicationStructureLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see fr.lagab.portlet.publication.service.impl.PublicationStructureLocalServiceImpl
 * @see fr.lagab.portlet.publication.service.PublicationStructureLocalServiceUtil
 * @generated
 */
public abstract class PublicationStructureLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PublicationStructureLocalService,
        IdentifiableBean {
    ...
    private PublicationStructureLocalServiceClpInvoker _clpInvoker = new PublicationStructureLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fr.lagab.portlet.publication.service.PublicationStructureLocalServiceUtil} to access the publication structure local service.
     */
