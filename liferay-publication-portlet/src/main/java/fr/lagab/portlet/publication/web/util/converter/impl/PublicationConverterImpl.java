package fr.lagab.portlet.publication.web.util.converter.impl;
...
import fr.lagab.portlet.publication.web.ddm.DDMFieldsCounter;
import fr.lagab.portlet.publication.web.ddm.DDMImpl;
import fr.lagab.portlet.publication.web.util.converter.PublicationConverter;
 ...
 * @since  21/10/15.
 */
public class PublicationConverterImpl implements PublicationConverter{

    public PublicationConverterImpl() {
    ...
    protected Serializable getDocumentLibraryValue(String url) {
        try {
            ...
            FileEntry fileEntry =
                    DLAppLocalServiceUtil.getFileEntryByUuidAndGroupId(parts[5], groupId);
    ...
    protected void updateDynamicContentValue(Element dynamicContentElement, String fieldType, String fieldValue)
        ...
        if (DDMImpl.TYPE_CHECKBOX.equals(fieldType)) {
            ...
            FileEntry fileEntry = DLAppLocalServiceUtil.getFileEntryByUuidAndGroupId(
                            uuid, groupId);
    ...
    private static Log _log = LogFactoryUtil.getLog(PublicationConverterImpl.class);
