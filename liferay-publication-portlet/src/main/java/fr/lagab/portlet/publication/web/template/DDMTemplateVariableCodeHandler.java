...
public class DDMTemplateVariableCodeHandler implements TemplateVariableCodeHandler {
    ...
    public String[] generate(
        ...
        String resourceName = getResourceName(templateVariableDefinition.getDataType());
        ...
        return handleRepeatableField(templateVariableDefinition, language, dataContentArray);
    }
    ...
    protected Template getTemplate(String resource) throws Exception {
        ...
        return TemplateManagerUtil.getTemplate(TemplateConstants.LANG_TYPE_FTL, templateResource, false);
    }
    ...
    protected String[] handleRepeatableField(
        ...
        dataContentArray[0] = lines[0] + StringPool.NEW_LINE + StringPool.TAB + lines[1];
        dataContentArray[1] = tempDataContent0 + dataContentArray[1] + dataContentArray[2];
