...
public class DDMImpl implements DDM {
    ...
    @Override
    public Fields getFields( long ddmStructureId, long ddmTemplateId, ServiceContext serviceContext)
            throws PortalException, SystemException {

        return getFields(ddmStructureId, ddmTemplateId, StringPool.BLANK, serviceContext);
    }

    @Override
    public Fields getFields(long ddmStructureId, long ddmTemplateId, String fieldNamespace, ServiceContext serviceContext)
            throws PortalException, SystemException {
    ...
    public String[] getFieldsDisplayValues(Field fieldsDisplayField) throws Exception {
        ...
        String[] values = StringUtil.split((String)fieldsDisplayField.getValue());
    ...
    protected Field createField(DDMStructure ddmStructure,
                                String fieldName, List<Serializable> fieldValues,
    ...
    protected List<String> getFieldNames(
        ...
        List<String> privateFieldNames = ListUtil.fromArray(
                PropsKeys.DYNAMIC_DATA_MAPPING_STRUCTURE_PRIVATE_FIELD_NAMES.split(StringPool.COMMA));
    ...
    protected List<Serializable> getFieldValues(
        ...
        for (String fieldNameValue : fieldNames) {
            ...
            Serializable fieldValueSerializable =FieldConstants.getSerializable(
