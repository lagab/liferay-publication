                ...
                <aui:fieldset label="asset-entry-type">
                    ...
                    <%
                        for (AssetRendererFactory assetRendererFactory : AssetRendererFactoryRegistryUtil.getAssetRendererFactories(company.getCompanyId())) {
                            ...
                            String className = _getClassName(assetRendererFactory);
...
<aui:script use="aui-base">
    ...
    <%
        for (AssetRendererFactory curRendererFactory : classTypesAssetRendererFactories) {
            String className = _getClassName(curRendererFactory);
    %>
...
<%!
    ...
    private String  _getClassName( AssetRendererFactory assetRendererFactory) {
        String className = AssetPublisherUtil.getClassName(assetRendererFactory);
        if( className.contains("$Proxy")){
            int pos = assetRendererFactory.getClassName().lastIndexOf(StringPool.PERIOD);
            className = assetRendererFactory.getClassName().substring(pos + 1);
